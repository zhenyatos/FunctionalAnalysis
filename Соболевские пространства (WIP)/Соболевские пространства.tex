...
\begin{definition}{Липшицева область}{}
	...
	\end{enumerate}
\end{definition}
%TODO: Определение достаточно объемное, следует добавить иллюстрации
...
\begin{theorem}{О продолжении}{}
	Пусть $\Omega$ -- липшицева область, $\Omega \ssubset \Omega_0$, тогда 
	\begin{equation*}
